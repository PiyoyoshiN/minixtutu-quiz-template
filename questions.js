...
const QUESTIONS = [
  ...
  {
    id: "sports-nutrition-02-001",
    category: "スポーツ栄養学②",
    type: "single",
    prompt: "次の脂質に関する記述のうち、正しいものを1つ選びなさい。",
    choices: [
      "脂質は1gあたり4kcalのエネルギーを産生する。",
      "牛脂や豚脂の動物性脂質は、魚油に多いEPAやDHAと同様に、血中コレステロール低下作用がある。",
      "脂質は水溶性ビタミンの吸収に役立つ。",
      "人の体内で合成することができないため、食事から摂取しなければならない脂肪酸を必須脂肪酸という。"
    ],
    answer: [4],
    explanation: "必須脂肪酸は、人の体内で合成できないため食事から摂取する必要がある脂肪酸です。脂質は1gあたり9kcalで、吸収を助けるのは水溶性ビタミンではなく脂溶性ビタミンです。"
  },
  {
    id: "sports-nutrition-02-002",
    category: "スポーツ栄養学②",
    type: "single",
    prompt: "次の脂質に関する記述のうち、誤っているものを1つ選びなさい。",
    choices: [
      "リノール酸は不飽和脂肪酸である。",
      "ドコサヘキサエン酸は、n-6系脂肪酸である。",
      "脂肪酸とはカルボキシ基を1つ持ち、炭素原子が鎖状に連結したカルボン酸の総称である。",
      "脂質は、炭素、水素、酸素を含む。"
    ],
    answer: [2],
    explanation: "ドコサヘキサエン酸、つまりDHAはn-6系ではなくn-3系脂肪酸です。リノール酸はn-6系の不飽和脂肪酸で、脂肪酸はカルボキシ基を持つカルボン酸の総称です。"
  },
  {
    id: "sports-nutrition-02-003",
    category: "スポーツ栄養学②",
    type: "single",
    prompt: "脂肪酸に関する記述について、正しいものを1つ選びなさい。",
    choices: [
      "二重結合を持つ脂肪酸を、飽和脂肪酸という。",
      "不飽和脂肪酸は化学的に不安定で、酸化しやすい。",
      "飽和脂肪酸は、血中コレステロールの低下作用があり、動脈硬化を抑制する働きがある。",
      "不飽和脂肪酸は、豚脂や牛脂に含まれ、常温で固体である。"
    ],
    answer: [2],
    explanation: "不飽和脂肪酸は二重結合を持つため化学的に不安定で、酸化しやすい性質があります。飽和脂肪酸は二重結合を持たず、常温で固体の動物性油脂に多く含まれます。"
  },
  {
    id: "sports-nutrition-02-004",
    category: "スポーツ栄養学②",
    type: "single",
    prompt: "脂肪酸について誤っているものを1つ選びなさい。",
    choices: [
      "中鎖脂肪酸の吸収は小腸リンパ管から胸管に送り込まれる。",
      "魚油にはEPA（IPA）、DHAが含まれる。",
      "飽和脂肪酸は二重結合を含まない脂肪酸である。",
      "オレイン酸は一価不飽和脂肪酸である。"
    ],
    answer: [1],
    explanation: "中鎖脂肪酸は比較的水に溶けやすく、主に門脈から吸収されます。リンパ管から吸収されやすいのは長鎖脂肪酸です。魚油にはEPA（IPA）やDHAが含まれ、オレイン酸は一価不飽和脂肪酸です。"
  },
  {
    id: "sports-nutrition-02-005",
    category: "スポーツ栄養学②",
    type: "single",
    prompt: "次の脂肪酸のうち、必須脂肪酸を1つ選びなさい。",
    choices: [
      "ステアリン酸",
      "ラウリン酸",
      "アラキドン酸",
    ...
    answer: [3],
    explanation: "広い意味での必須脂肪酸にはn-3系脂肪酸とn-6系脂肪酸が含まれます。アラキドン酸はn-6系脂肪酸です。ステアリン酸やラウリン酸は飽和脂肪酸、オレイン酸はn-9系の一価不飽和脂肪酸です。"
  },
  {
