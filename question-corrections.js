...

{
  const sampleQuestions = [
    ...
    },
    {
      ...
      answer: [1],
      explanation: "正解は「一定レベル以上にした後、ゲーム機を逆さまにする」。マーイーカは一定レベル以上で、本体を逆さまにした状態でレベルアップするとカラマネロに進化します。やみのいしを使うわけでも、名前を「マイッカ」にするわけでもありません。ましてやゲーム機を投げ合ってキャッチボールするのは進化条件以前に普通に危ないです。"
    }
  ];
